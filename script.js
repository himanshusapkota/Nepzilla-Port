...
const phrases=['Web Developer','Graphics Designer','UI/UX Designer','Creative Problem Solver','Currently learning AI/ML 🤖'];
...
const obs=new IntersectionObserver((entries)=>{
  entries.forEach(e=>{
    if(e.isIntersecting){
      ...
      // animate skill bars
      e.target.querySelectorAll && e.target.querySelectorAll('.skill-fill').forEach(b=>{
...
// PROJECTS
const projects=[
  {emoji:'🌐',bg:0,title:'Portfolio Website',desc:'A modern, animated personal portfolio built with cutting-edge web technologies, featuring dark/light mode and smooth scroll animations.',tags:['HTML','CSS','JS'],github:'#',demo:'#'},
  {emoji:'🏢',bg:1,title:'Business Landing Page',desc:'High-converting business landing page with persuasive copy layout, animated hero, service cards, and an integrated contact form.',tags:['HTML','CSS','JavaScript'],github:'#',demo:'#'},
  {emoji:'🛒',bg:2,title:'E-commerce UI Design',desc:'Complete UI/UX design for a modern e-commerce platform — product pages, cart flow, and checkout experience crafted in Figma.',tags:['Figma','UI/UX','Design'],github:'#',demo:'#'},
  {emoji:'📊',bg:3,title:'Dashboard UI',desc:'Admin analytics dashboard with real-time data visualization, dark mode, and a fully responsive sidebar-based layout.',tags:['HTML','CSS','JS','Figma'],github:'#',demo:'#'},
];
...
// EXPERIENCE
const exps=[
  {date:'2022 – Present',title:'Freelance Web Developer & Designer',company:'Self-Employed · Remote',desc:'Delivering end-to-end web solutions for clients ranging from local businesses to international startups. Specializing in modern, responsive websites and compelling UI/UX designs that drive conversions.',tags:['HTML','CSS','JS','Figma','Photoshop']},
  {date:'2021 – 2022',title:'Junior Frontend Developer',company:'Creative Projects · Contract',desc:'Built and maintained responsive web interfaces for multiple client projects. Collaborated with designers and stakeholders to translate wireframes and mockups into pixel-perfect, functional code.',tags:['HTML','CSS','JavaScript','Responsive Design']},
  {date:'2020 – 2021',title:'Graphic Designer',company:'Freelance · Remote',desc:'Created visual assets including logos, banners, social media graphics, and marketing materials. Developed strong aesthetic sensibility and attention to detail that now informs my development work.',tags:['Canva','Photoshop','Figma','Branding']},
];
...
function submitForm(){
  ...
  if(!n||!e||!m){showToast('Please fill in all required fields ⚠️');return;}
